...
module.exports = async (req, res) => {
  ...
  // Fixed top-level path — not nested under a house — so there's no ambiguity
  // about which of your houses to check. Look under /debug/lastNotify directly.
  async function writeDebug(extra) {
    try {
      const fbAdmin = getAdmin();
      await fbAdmin.database().ref('/debug/lastNotify').set(Object.assign({
